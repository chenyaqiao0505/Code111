    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('remark', models.CharField(help_text='备注', max_length=200, verbose_name='备注')),
                ('cabinet', models.ForeignKey(help_text='所在机柜', null=True, on_delete=None, to='cabinet.Cabinet', verbose_name='所在机柜')),
                ('idc', models.ForeignKey(help_text='所在机房', null=True, on_delete=None, to='idcs.Idc', verbose_name='所在机房')),
                ('manufacturer', models.ForeignKey(help_text='制造商', on_delete=None, to='manufacturer.Manufacturer', verbose_name='制造商')),
                ('model_name', models.ForeignKey(help_text='服务型号', on_delete=None, to='manufacturer.ProductModel', verbose_name='服务型号')),
            ],
            options={
