...
class Manufacturer(models.Model):
    ...
    email       = models.EmailField('电子邮件',max_length=32,help_text='电子邮件')
    remark      = models.CharField('备注',max_length=256,help_text='备注')
...
class ProductModel(models.Model):
    ...
    vendor     = models.ForeignKey(Manufacturer,verbose_name='所属制造商',on_delete=True,help_text='所属制造商')
