    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='电子邮件', max_length=32, verbose_name='电子邮件')),
                ('remark', models.CharField(help_text='备注', max_length=256, verbose_name='备注')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('vendor', models.ForeignKey(help_text='所属制造商', on_delete=True, to='manufacturer.Manufacturer', verbose_name='所属制造商')),
            ],
            options={
