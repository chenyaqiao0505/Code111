...
file_dir = 'C:\\Users\\Mac\\Desktop\\测试记录\\DO'
...
def all_to_one(root, allFile_url, files, file_name='allExcel.xls', title=None):
...
btu = Button(win, text='开始汇总',command=lambda: all_to_one(root, allFile_url, files=files, file_name=file_name, title=title)).grid(row=2,column=0,pady=3)
